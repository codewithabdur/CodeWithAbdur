...
export default function Home({ blogs, profile }) {
  ...
  //   title: "WorkWithAbdur",
  //   name: "Abdur",
  //   image: "Picsart_22-06-25_12-52-33-223 - Edited",
  //   fbLink: "https://www.facebook.com/people/Saqib-Khan",
  //   youtubeLink: "www.youtube.com/c/LucyGamer01",
  //   instagramLink: "https://www.instagram.com/its_paithan",
  // };
  ...
  return (
    <><>
      ...
      <Head>
        ...
        <meta
          name="description"
          content="Hey! Buddy I am Abdur Rahman Khan And I am a coder and this is my first website of Portfolio By Sanity." />
        ...
        <div className="container flex flex-col items-center py-16 md:py-20 lg:flex-row">
          <div className="w-full text-center sm:w-3/4 lg:w-3/5 lg:text-left">
            ...
            <h4 className="pt-6 font-header text-xl font-medium text-black sm:text-2xl lg:text-3xl">
              I'm Abdur Rahman Khan, a Web Designer & Photographer
            </h4>
            <p className="pt-6 font-body leading-relaxed text-grey-20">
              Hey! Buddy I am Abdur Rahman Khan And I am a coder and this is my first website of Portfolio By Sanity.
              You Guys Are going to take intrest in My projects Video in Youtube  and link of my channel is Given Above to The NavBar.
            </p>
        ...
        <div className="grid grid-cols-1 gap-6 pt-10 sm:grid-cols-2 md:gap-10 md:pt-12 lg:grid-cols-3">
          <div className="group rounded px-8 py-12 shadow hover:bg-primary">
            ...
            <div className="text-center">
              ...
              <p className="text-grey pt-4 text-sm group-hover:text-white md:text-base">
                I am a Beginer in Website Development But Not Noob I am As Equal To masers What They Can Do I do too 90% Same.
                So You can Say that I am a bachelor in this.
              </p>
            </div>
          </div>
          <div className="group rounded px-8 py-12 shadow hover:bg-primary">
            ...
            <div className="text-center">
              ...
              <p className="text-grey pt-4 text-sm group-hover:text-white md:text-base">
                I am Master in Technical Writing. I have Soft Skill Knowledge too.
                Yeah! I Know You Say that all the line i write in it they are in wrong order or disturb case So. Don't worry .
                This Only for Test.
              </p>
            </div>
          </div>
          ...
          <div className="group rounded px-8 py-12 shadow hover:bg-primary">
            ...
            <div className="text-center">
              ...
              <p className="text-grey pt-4 text-sm group-hover:text-white md:text-base">
                I have a Knowledge  of Blender and I am done Saveral Project by Using Blender.
              </p>
            </div>
          </div>
          <div className="group rounded px-8 py-12 shadow hover:bg-primary">
            ...
            <div className="text-center">
              ...
              <p className="text-grey pt-4 text-sm group-hover:text-white md:text-base">
                You See This Website as Example How i am in please let me know in feedback.
              </p>
            </div>
          </div>
        </div>
                ...
                <div className="mt-1 flex">
                  ...
                  <div className="md:-mt-1 md:pl-8">
                    ...
                    <span className="block pt-2 font-header text-xl font-bold uppercase text-primary">Frontend
                      Developer</span>
                    <div className="pt-2">CodeWithAbdur
                      <span className="block font-body text-black">Front-end web development is the development of the graphical user interface of a website, through the use of HTML, CSS, and JavaScript, so that users can view and interact with that website</span>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="mt-1 flex">
                  ...
                  <div className="md:-mt-1 md:pl-8">
                    ...
                    <span className="block pt-2 font-header text-xl font-bold uppercase text-primary">DevOps
                      Engineer</span>
                    <div className="pt-2">
                      <span className="block font-body text-black">Sep., 1993. Mezak, Steve (25 January 2018).
                        "The Origins of DevOps: What's in a Name?". devops.com.
                        Retrieved 6 May 2019. Debois, Patrick (9 October 2008)</span>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <div className="container py-16 md:py-20" id="contact">
          ...
          <p className="font-body text-grey-10">
            Hey Buddy!
                    If You have any query please let me know.
                      Actually do one thing send me message by filling this form given below.
                               Thank You.
          </p>
        </div>
        ...
        <div className="flex flex-col pt-16 lg:flex-row">
          ...
          <div
            ...
            <p className="pt-2 text-left font-body font-bold text-primary lg:text-lg">
              123 samanpura, Raza Bazar, Patna(Bihar)
            </p>
          </div>
        </div>
      </div>
