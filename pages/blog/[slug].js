        ...
        <div class="mx-auto max-w-4xl">
          <div class="">
            ...
            <div class="flex items-center pt-5 md:pt-10">
              ...
              <div class="pl-5">
                <span class="block font-body text-xl font-bold text-grey-10">By Abdur Rahman Khan</span>
            ...
            <div class="ml-0 text-center md:ml-10 md:w-5/6 md:text-left">
              ...
              <p
                ...
                The World Programming System, also known as WPS Analytics or WPS, is a software product developed by a company called World Programming.
                      ...
                      WPS Analytics supports users of mixed ability to access and process data and to perform data science tasks. 
                      It has interactive visual programming tools using data workflows, 
                        and it has coding tools supporting the use of the SAS language mixed with Python, R and SQL.
